...
export const LandingScreen = ({ onNavigate }: { onNavigate: () => void }) => {
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-background-soft p-6 text-center">
      ...
      <div className="flex flex-col items-start w-fit mx-auto mb-10 mt-6 select-none relative">
  ...
  return (
    <div className="flex flex-col min-h-screen bg-[#f7f8fa] overflow-hidden relative">
      ...
      <div className="relative w-full flex justify-center mt-4 z-10">
        <div className="w-[85%] max-w-[320px] bg-white rounded-t-[32px] rounded-b-[16px] shadow-2xl pb-8 overflow-hidden relative border border-slate-100 flex flex-col pt-12 px-6 gap-6">
          ...
          <div className="flex flex-col gap-4 font-bold text-xs">
            <div className="flex justify-between items-center text-slate-400">
              ...
              <div className="flex items-center gap-2">
                ...
                <span className="text-purple-700 text-base">$850</span>
              </div>
            </div>
            <div className="flex justify-between items-center text-slate-400">
              ...
              <div className="flex items-center gap-2">
                ...
                <span className="text-purple-700 text-base">$3200</span>
              </div>
            </div>
            <div className="flex justify-between items-center text-slate-400">
              ...
              <div className="flex items-center gap-2">
                ...
                <span className="text-purple-700 text-base">$1500</span>
              </div>
            </div>
            <div className="flex justify-between items-center text-slate-400">
              ...
              <div className="flex items-center gap-2">
                ...
                <span className="text-purple-700 text-base">$1200</span>
              </div>
            </div>
          </div>
          ...
          <div className="flex justify-end gap-2 mt-2">
            ...
            <div className="w-8 h-8 rounded-full bg-fuchsia-50 flex items-center justify-center text-fuchsia-500">
              <CreditCard size={14} />
            </div>
          </div>

          <div className="border-t border-dashed border-slate-200 mt-2 pt-6 flex justify-between items-center">
            <span className="text-sm font-black text-slate-400 tracking-widest uppercase">A Pagar</span>
            <div className="flex items-center gap-2">
              <CheckCircle2 size={16} className="text-primary-green" />
              <span className="text-3xl font-black text-purple-800">$6750</span>
            </div>
          </div>

          {/* Ticket Scalloped Bottom Edge */}
          <div
            className="absolute bottom-[-1px] left-0 w-full h-[12px]"
            style={{
              backgroundImage: 'radial-gradient(circle at 10px 10px, transparent 10px, #f7f8fa 11px)',
      ...
      <div className="flex flex-col items-center flex-1 px-8 pt-8 pb-12 text-center z-10 w-full max-w-sm mx-auto">
        <p className="text-[#64748b] mb-10 max-w-[280px] font-bold text-[15px] leading-relaxed">
          Inicia sesión con tu cuenta de Google para guardar tus listas, métodos de pago y recibir alertas.
        </p>

        <button
          onClick={login}
          className="w-full bg-white text-slate-800 font-extrabold text-[15px] py-[18px] px-6 rounded-[20px] shadow-md border border-slate-100 hover:shadow-lg flex items-center justify-center gap-3 transition-all active:scale-[0.98]"
        >
